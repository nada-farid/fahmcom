...
class OurServicesController extends Controller
{
    ...
    public function index()
    {
        ...
        $ourServices = OurService::with(['type', 'media'])->get();
    ...
    public function create()
    {
        ...
        $types = ServieceType::pluck('type', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.ourServices.create', compact('types'));
    }
    ...
    public function edit(OurService $ourService)
    {
        ...
        $ourService->load('type');

        return view('admin.ourServices.edit', compact('ourService', 'types'));
    }
    ...
    {
        OurService::whereIn('id', request('ids'))->delete();
